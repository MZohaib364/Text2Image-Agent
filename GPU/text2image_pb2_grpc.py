...
class Text2ImageServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GenerateImage = channel.unary_unary(
                ...
                request_serializer=text2image__pb2.ImageRequest.SerializeToString,
...
def add_Text2ImageServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GenerateImage': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=text2image__pb2.ImageRequest.FromString,
...
class Text2ImageService(object):
    ...
    def GenerateImage(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/text2image.Text2ImageService/GenerateImage',
            text2image__pb2.ImageRequest.SerializeToString,
